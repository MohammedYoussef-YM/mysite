...
def community(request):
    ...
    return render(request, 'mysite/community.html', communities)
...
def customers(request):
    ...
    return render(request, 'mysite/customers.html', customers)
...
def members(request):
    ...
    return render(request, "mysite/members.html", members)
...
def ourServices(request):
    ...
    return render(request, "mysite/ourservices.html",ourServices)
...
def hasad(request):
    ...
    return render(request, "mysite/hasd.html",hasads)
...
def locationBarnch(request):
    ...
    return render(request, "mysite/locationbarnch.html",locationBarnches)
...
def ourNew(request):
    ...
    return render(request, "mysite/whatnew.html",newses)
...
def about(request):
    ...
    return render(request, "mysite/aboutus.html",abouts)
